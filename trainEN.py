...
from settings import EMBEDDINGS_FILE_EN, CHECKPOINTS_PATH, TENSORBOARD_PATH, \
    OBJ_FILE_EN, SUBJ_FILE_EN, TEST_FILE_EN
import os
import numpy as np
...
def create_checkpoints():
    cp_cb = ModelCheckpoint(filepath=os.path.join(CHECKPOINTS_PATH, "subjectivity-en.{epoch:02d}.hdf5"), monitor='val_loss',
                            save_best_only=True)
...
if __name__ == "__main__":
    ...
    sentences, labels = extract_save_test(sentences, labels, test_p, TEST_FILE_EN)
